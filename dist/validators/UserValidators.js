...
class UserValidators {
    ...
    static verifyUser() {
        return [
            (0, express_validator_1.body)("verification_token", "Verification Token is Required").isNumeric(),
        ];
    }
    ...
    static resetPassword() {
        return [
            ...
            (0, express_validator_1.body)("confirm_password", "Confirm Password is Required").isAlphanumeric(),
            (0, express_validator_1.body)("reset_password_token", "Reset Password Token")
                .isNumeric()
                .custom((token, { req }) => {
    ...
    static updateProfilePic() {
        return [
            (0, express_validator_1.body)("profile_pic").custom((profilePic, { req }) => {
                if (req.file) {
                    return true;
                }
                else {
